...
{   
    Console.Clear();
    Console.WriteLine($"Перед вами строковый массив, заполненный случайными значениями и новый массив, который отображает элементы предудещего массива, длина которых равна трём или менее символов:");
    Console.WriteLine();
